...
for (j in 1:length(possible.ns)){
  ...
  for (i in 1:sims){
    ...
    p.T1vsT2[i] <- summary(fit.T1vsT2.sim)$coefficients[2,1]
    p.T1vsT3[i] <- summary(fit.T1vsT3.sim)$coefficients[2,1]
    p.T1vsT4[i] <- summary(fit.T1vsT4.sim)$coefficients[2,1]
    p.T2vsT3[i] <- summary(fit.T2vsT3.sim)$coefficients[2,1]
    p.T2vsT4[i] <- summary(fit.T2vsT4.sim)$coefficients[2,1]
    p.T3vsT4[i] <- summary(fit.T3vsT4.sim)$coefficients[2,1]
    c.T1vsT2[i] <- summary(fit.T1vsT2.sim)$coefficients[2,4]
    c.T1vsT3[i] <- summary(fit.T1vsT3.sim)$coefficients[2,4]
    c.T1vsT4[i] <- summary(fit.T1vsT4.sim)$coefficients[2,4]
    c.T2vsT3[i] <- summary(fit.T2vsT3.sim)$coefficients[2,4]
    c.T2vsT4[i] <- summary(fit.T2vsT4.sim)$coefficients[2,4]
    c.T3vsT4[i] <- summary(fit.T3vsT4.sim)$coefficients[2,4]
  }
